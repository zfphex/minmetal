...
impl Heap {
    ...
    pub fn current_allocated_size(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"currentAllocatedSize\0")) }
    }
...
impl ArgumentEncoder {
    pub fn encoded_length(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"encodedLength\0")) }
    }

    pub fn alignment(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"alignment\0")) }
    }
...
impl SharedEvent {
    pub fn signaled_value(&self) -> u64 {
        unsafe { msg_u64(self.raw, sel(b"signaledValue\0")) }
    }
