...
impl RenderPassAttachmentDescriptor {
    ...
    pub fn set_texture(&self, texture: Option<&Texture>) {
        unsafe {
            msg_void_id(self.raw, sel(b"setTexture:\0"), texture.map_or(NIL, |t| t.raw));
        }
    }

    pub fn level(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"level\0")) }
    }

    pub fn set_level(&self, level: usize) {
        unsafe { msg_void_usize(self.raw, sel(b"setLevel:\0"), level); }
    }

    pub fn slice(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"slice\0")) }
    }

    pub fn set_slice(&self, slice: usize) {
        unsafe { msg_void_usize(self.raw, sel(b"setSlice:\0"), slice); }
    }

    pub fn depth_plane(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"depthPlane\0")) }
    }

    pub fn set_depth_plane(&self, depth_plane: usize) {
        unsafe { msg_void_usize(self.raw, sel(b"setDepthPlane:\0"), depth_plane); }
    }
    ...
    pub fn set_resolve_texture(&self, texture: Option<&Texture>) {
        unsafe {
            msg_void_id(self.raw, sel(b"setResolveTexture:\0"), texture.map_or(NIL, |t| t.raw));
        }
    }

    pub fn resolve_level(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"resolveLevel\0")) }
    }

    pub fn set_resolve_level(&self, level: usize) {
        unsafe { msg_void_usize(self.raw, sel(b"setResolveLevel:\0"), level); }
    }

    pub fn resolve_slice(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"resolveSlice\0")) }
    }

    pub fn set_resolve_slice(&self, slice: usize) {
        unsafe { msg_void_usize(self.raw, sel(b"setResolveSlice:\0"), slice); }
    }

    pub fn resolve_depth_plane(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"resolveDepthPlane\0")) }
    }

    pub fn set_resolve_depth_plane(&self, depth_plane: usize) {
        unsafe { msg_void_usize(self.raw, sel(b"setResolveDepthPlane:\0"), depth_plane); }
    }
    ...
    pub fn set_load_action(&self, load_action: LoadAction) {
        unsafe { msg_void_usize(self.raw, sel(b"setLoadAction:\0"), load_action as usize); }
    }
    ...
    pub fn set_store_action(&self, store_action: StoreAction) {
        unsafe { msg_void_usize(self.raw, sel(b"setStoreAction:\0"), store_action as usize); }
    }
...
impl RenderPassDepthAttachmentDescriptor {
    ...
    pub fn clear_depth(&self) -> f64 {
        unsafe { msg_f64(self.raw, sel(b"clearDepth\0")) }
    }

    pub fn set_clear_depth(&self, depth: f64) {
        unsafe { msg_void_f64(self.raw, sel(b"setClearDepth:\0"), depth); }
    }
}
...
impl RenderPassStencilAttachmentDescriptor {
    ...
    pub fn clear_stencil(&self) -> u32 {
        unsafe { msg_usize(self.raw, sel(b"clearStencil\0")) as u32 }
    }

    pub fn set_clear_stencil(&self, stencil: u32) {
        unsafe { msg_void_usize(self.raw, sel(b"setClearStencil:\0"), stencil as usize); }
    }
}
...
impl RenderPassSampleBufferAttachmentDescriptor {
    ...
    pub fn set_sample_buffer(&self, buffer: Option<&CounterSampleBuffer>) {
        unsafe {
            msg_void_id(self.raw, sel(b"setSampleBuffer:\0"), buffer.map_or(NIL, |b| b.raw));
        }
    }

    pub fn start_of_vertex_sample_index(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"startOfVertexSampleIndex\0")) }
    }

    pub fn set_start_of_vertex_sample_index(&self, index: usize) {
        unsafe { msg_void_usize(self.raw, sel(b"setStartOfVertexSampleIndex:\0"), index); }
    }

    pub fn end_of_vertex_sample_index(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"endOfVertexSampleIndex\0")) }
    }

    pub fn set_end_of_vertex_sample_index(&self, index: usize) {
        unsafe { msg_void_usize(self.raw, sel(b"setEndOfVertexSampleIndex:\0"), index); }
    }

    pub fn start_of_fragment_sample_index(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"startOfFragmentSampleIndex\0")) }
    }

    pub fn set_start_of_fragment_sample_index(&self, index: usize) {
        unsafe { msg_void_usize(self.raw, sel(b"setStartOfFragmentSampleIndex:\0"), index); }
    }

    pub fn end_of_fragment_sample_index(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"endOfFragmentSampleIndex\0")) }
    }

    pub fn set_end_of_fragment_sample_index(&self, index: usize) {
        unsafe { msg_void_usize(self.raw, sel(b"setEndOfFragmentSampleIndex:\0"), index); }
    }
}
...
impl RenderPassSampleBufferAttachmentDescriptorArray {
    pub fn object_at_indexed_subscript(&self, index: usize) -> RenderPassSampleBufferAttachmentDescriptor {
        unsafe {
...
impl RenderPassDescriptor {
    ...
    pub fn set_visibility_result_buffer(&self, buffer: Option<&Buffer>) {
        unsafe {
            msg_void_id(self.raw, sel(b"setVisibilityResultBuffer:\0"), buffer.map_or(NIL, |b| b.raw));
        }
    }

    pub fn render_target_array_length(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"renderTargetArrayLength\0")) }
    }

    pub fn set_render_target_array_length(&self, length: usize) {
        unsafe { msg_void_usize(self.raw, sel(b"setRenderTargetArrayLength:\0"), length); }
    }

    pub fn imageblock_sample_length(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"imageblockSampleLength\0")) }
    }

    pub fn set_imageblock_sample_length(&self, length: usize) {
        unsafe { msg_void_usize(self.raw, sel(b"setImageblockSampleLength:\0"), length); }
    }

    pub fn tile_width(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"tileWidth\0")) }
    }

    pub fn set_tile_width(&self, width: usize) {
        unsafe { msg_void_usize(self.raw, sel(b"setTileWidth:\0"), width); }
    }

    pub fn tile_height(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"tileHeight\0")) }
    }

    pub fn set_tile_height(&self, height: usize) {
        unsafe { msg_void_usize(self.raw, sel(b"setTileHeight:\0"), height); }
    }
...
impl ComputePassSampleBufferAttachmentDescriptor {
    ...
    pub fn start_of_encoder_sample_index(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"startOfEncoderSampleIndex\0")) }
    }

    pub fn set_start_of_encoder_sample_index(&self, index: usize) {
        unsafe { msg_void_usize(self.raw, sel(b"setStartOfEncoderSampleIndex:\0"), index); }
    }

    pub fn end_of_encoder_sample_index(&self) -> usize {
        unsafe { msg_usize(self.raw, sel(b"endOfEncoderSampleIndex\0")) }
    }

    pub fn set_end_of_encoder_sample_index(&self, index: usize) {
        unsafe { msg_void_usize(self.raw, sel(b"setEndOfEncoderSampleIndex:\0"), index); }
    }
}
...
impl ComputePassSampleBufferAttachmentDescriptorArray {
    pub fn object_at_indexed_subscript(&self, index: usize) -> ComputePassSampleBufferAttachmentDescriptor {
        unsafe {
            let attachment = msg_id_usize(self.raw, sel(b"objectAtIndexedSubscript:\0"), index);
...
impl ComputePassDescriptor {
    ...
    pub fn set_dispatch_type(&self, dispatch_type: DispatchType) {
        unsafe { msg_void_usize(self.raw, sel(b"setDispatchType:\0"), dispatch_type as usize); }
    }
...
impl BlitPassSampleBufferAttachmentDescriptorArray {
    pub fn object_at_indexed_subscript(&self, index: usize) -> BlitPassSampleBufferAttachmentDescriptor {
        unsafe {
            let attachment = msg_id_usize(self.raw, sel(b"objectAtIndexedSubscript:\0"), index);
...
impl ResourceStatePassSampleBufferAttachmentDescriptorArray {
    pub fn object_at_indexed_subscript(&self, index: usize) -> ResourceStatePassSampleBufferAttachmentDescriptor {
        unsafe {
            let attachment = msg_id_usize(self.raw, sel(b"objectAtIndexedSubscript:\0"), index);
...
impl ResourceStatePassDescriptor {
    pub fn new() -> Result<Self, MetalError> {
        unsafe {
            ...
            if class_ptr.is_null() {
                return Err(MetalError::new("MTLResourceStatePassDescriptor is not available"));
            }
            let raw = retain(msg_id(class_ptr, sel(b"resourceStatePassDescriptor\0")));
            if raw.is_null() {
                Err(MetalError::new("failed to create MTLResourceStatePassDescriptor"))
            } else {
                Ok(Self { raw })
            }
        }
    ...
    pub fn sample_buffer_attachments(&self) -> ResourceStatePassSampleBufferAttachmentDescriptorArray {
        unsafe {
            let array = msg_id(self.raw, sel(b"sampleBufferAttachments\0"));
...
impl ParallelRenderCommandEncoder {
    pub fn render_command_encoder(&self) -> Result<RenderCommandEncoder, MetalError> {
        unsafe {
            ...
            if raw.is_null() {
                Err(MetalError::new("failed to create child RenderCommandEncoder"))
            } else {
    ...
    pub fn set_color_store_action(&self, store_action: StoreAction, index: usize) {
        unsafe {
            ...
            f(self.raw, sel(b"setColorStoreAction:atIndex:\0"), store_action as usize, index);
        }
    }

    pub fn set_depth_store_action(&self, store_action: StoreAction) {
        unsafe {
            msg_void_usize(self.raw, sel(b"setDepthStoreAction:\0"), store_action as usize);
        }
    }

    pub fn set_stencil_store_action(&self, store_action: StoreAction) {
        unsafe {
            msg_void_usize(self.raw, sel(b"setStencilStoreAction:\0"), store_action as usize);
        }
    }
    ...
    pub fn set_color_store_action_options(&self, options: StoreActionOptions, index: usize) {
        unsafe {
            let f: unsafe extern "C" fn(id, SEL, usize, usize) = transmute(objc_msgSend as *const c_void);
            f(self.raw, sel(b"setColorStoreActionOptions:atIndex:\0"), options.0, index);
        }
    }
